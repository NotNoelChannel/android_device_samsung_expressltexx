...
/**
 * RIL customization for Galaxy Express (GSM) devices
 *
 * {@hide}
 */
public class ExpressRIL extends RIL {
    ...
    public ExpressRIL(Context context, int preferredNetworkType, int cdmaSubscription) {
